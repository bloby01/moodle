...
$CFG->dbuser    = 'mymoodleadmin';   // your database username
$CFG->dbpass    = 'FloydEstUneBreleDeDingue^^';   // your database password
...
$CFG->wwwroot   = 'http://localhost.local/moodle';
